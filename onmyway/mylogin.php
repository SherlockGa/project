...
<div class="center">
    ...
    <?php if(isset($_COOKIE["USER"])){ 
        $nn = $_COOKIE['USER'];
        $result = mysql_query("select * from detailnote where user = '{$nn}'");
    ?>
    <div class="myyouji">
        <div class="youjititle">
        <h2>我的游记</h2>
        </div>
        <button class="write" onclick="on1()">写游记</button>
        <div class="neirong">
            <ul>
    ...
    <div class="myyouji">
        ...
        <button class="write" onclick="on2()">写游记</button>
        <div class="neirong">
        </div>
    </div>
     <?php } ?>
