    ...
    setInterval(function(){    
        ...
        <div class="travel" id="_j_tn">
            ...
            <?php
                ...
                $sql = "select * from note order by hit desc limit 0,3";
                $sql1= "select * from detailnote order by hit desc limit 0,3";
                $res = mysql_query($sql);
            ...
            <div id="_j_tn_content">
                ...
                <div align="right" class="m-pagination" id="_j_tn_pagination" data-type="0" data-objid="0">
                    ...
                    <?php echo "1"; ?>
                    <a href="hothome.php?page=2">下一页</a>
                </div>
            </div>
        </div>
