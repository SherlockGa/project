...
<div class="header">
    <div class="header-wrap">
        <div class="logo">
            <a href="home.php"><img class="onmyway-logo" src="image/1490412678_721996.png" ></a>
        </div>
        <ul class="nav">
        ...
        <div class="travel" id="_j_tn">
            <div class="navbar clearfix">
                <ul class="tn-nav" id="_j_tn_nav">
                    ...
                    <li class="tab"><a href="hothome.php?page=1" rel="nofollow" data-type="0" data-objid="0">热门游记</a><span class="tn-menu _j_open_search"><i class="tn-menu-icon"></i>筛选</span></li>
                    <li class="active tab"><a href="newhome.php?page=1" rel="nofollow" data-type="3">最新发表</a></li>
                </ul>
            ...
            <?php
                ...
                $sql = "select * from note order by time desc limit $start,3";
                $sql1= "select * from detailnote order by time desc limit $start,3";
                $res = mysql_query($sql);
            ...
            <div id="_j_tn_content">
                ...
                <div align="right" class="m-pagination" id="_j_tn_pagination" data-type="0" data-objid="0">
                    ...
                    <a href="newhome.php?page=1">首页</a>
                    <?php if($page != 1){ ?>
                    <a href="newhome.php?page=<?php echo $page-1; ?>">上一页</a>
                    <?php } ?>
                    <?php echo $page; ?>
                    <a href="newhome.php?page=<?php echo $page+1; ?>">下一页</a>
                </div>
            </div>
        </div>
